"""security_of_cyber_physical_systems URL Configuration
...
urlpatterns = [
    ...
    url(r'^View_Attack_Status_Ratio/$', serviceprovider.View_Attack_Status_Ratio, name="View_Attack_Status_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Attack_Status/$', serviceprovider.View_Prediction_Of_Attack_Status, name="View_Prediction_Of_Attack_Status"),
